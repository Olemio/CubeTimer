...
var currentTimesArray = []; //array with all session times
var timesInserted = 0;
...
timeTableHeader(); //Display time list innerHTML
...
function insertDB(){ //Insert time to database
...
function calculateArrayAvg(myArray){ //Calculate avg from array
    var myArrayMedian = [];
    var averageSum = 0;
...
function averagePannelInnerHTML(){ //Display averages in average pannel innerHTML
...
function timeTableHeader(){ //Display time list innerHTML
